...
If chroot shows `y`:
- Token path: `/var/spool/postfix/etc/tokens/username@domain.com`

If chroot shows `n`:
- Token path: `/etc/tokens/username@domain.com`
...
If chroot enabled and seeing certificate errors, copy certificates:
